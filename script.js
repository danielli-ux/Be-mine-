...
Folder highlights
Code creates an interactive "Will you be my valentine?" page featuring rainbow color flashes and cat GIFs upon user response.
...
function selectOption(option) {
    ...
    // 1. Change text and grow the "Yes" button (keep your original logic)
...
function displayCat() {
    ...
    catImage.src = 'dog.jpg'; // Assuming the cat image is named "cat.gif"
